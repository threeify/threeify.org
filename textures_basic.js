(function () {
    ...
    class Shader {
        ...
        validate() {
            ...
            __classPrivateFieldSet(this, _validated, true);
        }
        dispose() {
            if (!this.disposed) {
    ...
    class TexImage2D {
        ...
        loadImage(image, target = undefined, level = 0) {
            ...
            if (image instanceof Vector2) {
                gl.texImage2D(target !== null && target !== void 0 ? target : this.target, level, this.internalFormat, image.width, image.height, 0, this.pixelFormat, this.pixelFormat, this.dataType, new Uint8Array(image.data));
                if (level === 0) {
    ...
    var _validated$1, _uniformsInitialized, _uniforms, _attributesInitialized, _attributes;
    class Program {
        ...
        validate() {
            ...
            __classPrivateFieldSet$1(this, _validated$1, true);
            return true;
        }
        get uniforms() {
            if (!__classPrivateFieldGet$2(this, _uniformsInitialized)) {
                ...
                for (let i = 0; i < numActiveUniforms; ++i) {
                    ...
                    __classPrivateFieldGet$2(this, _uniforms)[uniform.name] = uniform;
                }
                __classPrivateFieldSet$1(this, _uniformsInitialized, true);
            }
            return __classPrivateFieldGet$2(this, _uniforms);
        }
        get attributes() {
            if (!__classPrivateFieldGet$2(this, _attributesInitialized)) {
                const gl = this.context.gl;
                ...
                for (let i = 0; i < numActiveAttributes; ++i) {
                    ...
                    __classPrivateFieldGet$2(this, _attributes)[attribute.name] = attribute;
                }
                __classPrivateFieldSet$1(this, _attributesInitialized, true);
            }
            return __classPrivateFieldGet$2(this, _attributes);
        }
    ...
    _validated$1 = new WeakMap(), _uniformsInitialized = new WeakMap(), _uniforms = new WeakMap(), _attributesInitialized = new WeakMap(), _attributes = new WeakMap();
    ...
    class RenderingContext {
        constructor(canvas, attributes = undefined) {
            ...
            __classPrivateFieldSet$2(this, _framebuffer, this.canvasFramebuffer);
        }
        ...
        set program(program) {
            if (__classPrivateFieldGet$3(this, _program) !== program) {
                ...
                __classPrivateFieldSet$2(this, _program, program);
            }
        }
        get program() {
            return __classPrivateFieldGet$3(this, _program);
        }
        set framebuffer(framebuffer) {
            if (__classPrivateFieldGet$3(this, _framebuffer) !== framebuffer) {
                ...
                __classPrivateFieldSet$2(this, _framebuffer, framebuffer);
            }
        }
        get framebuffer() {
            return __classPrivateFieldGet$3(this, _framebuffer);
        }
        get scissor() {
            return __classPrivateFieldGet$3(this, _scissor).clone();
        }
        set scissor(s) {
            if (!__classPrivateFieldGet$3(this, _scissor).equals(s)) {
                this.gl.scissor(s.x, s.y, s.width, s.height);
                __classPrivateFieldGet$3(this, _scissor).copy(s);
            }
        }
        get viewport() {
            return __classPrivateFieldGet$3(this, _viewport).clone();
        }
        set viewport(v) {
            if (!__classPrivateFieldGet$3(this, _viewport).equals(v)) {
                this.gl.viewport(v.x, v.y, v.width, v.height);
                __classPrivateFieldGet$3(this, _viewport).copy(v);
            }
        }
        get blendState() {
            return __classPrivateFieldGet$3(this, _blendState).clone();
        }
        set blendState(bs) {
            if (!__classPrivateFieldGet$3(this, _blendState).equals(bs)) {
                ...
                __classPrivateFieldGet$3(this, _blendState).copy(bs);
            }
        }
        get depthTestState() {
            return __classPrivateFieldGet$3(this, _depthTestState).clone();
        }
        set depthTestState(dts) {
            if (!__classPrivateFieldGet$3(this, _depthTestState).equals(dts)) {
                if (dts.enabled) {
                ...
                __classPrivateFieldGet$3(this, _depthTestState).copy(dts);
            }
        }
        get clearState() {
            return __classPrivateFieldGet$3(this, _clearState).clone();
        }
        set clearState(cs) {
            if (!__classPrivateFieldGet$3(this, _clearState).equals(cs)) {
                this.gl.clearColor(cs.color.r, cs.color.g, cs.color.b, cs.alpha);
                this.gl.clearDepth(cs.depth);
                this.gl.clearStencil(cs.stencil);
                __classPrivateFieldGet$3(this, _clearState).copy(cs);
            }
        }
        get maskState() {
            return __classPrivateFieldGet$3(this, _maskState).clone();
        }
        set maskState(ms) {
            if (!__classPrivateFieldGet$3(this, _maskState).equals(ms)) {
                this.gl.colorMask(ms.red, ms.green, ms.blue, ms.alpha);
                this.gl.depthMask(ms.depth);
                this.gl.stencilMask(ms.stencil);
                __classPrivateFieldGet$3(this, _maskState).copy(ms);
            }
        }
        get cullingState() {
            return __classPrivateFieldGet$3(this, _cullingState).clone();
        }
        set cullingState(cs) {
            if (!__classPrivateFieldGet$3(this, _cullingState).equals(cs)) {
                if (cs.enabled) {
                ...
                __classPrivateFieldGet$3(this, _cullingState).copy(cs);
            }
        }
...
`;
    ...
    var _bufferGeometry, _program$1, _layers, _layerVersion, _offlineLayerVersion;
    ...
    class LayerCompositor {
        constructor(canvas) {
            ...
            _program$1.set(this, void 0);
            this.imageSize = new Vector2(0, 0);
            this.zoomScale = 1.0;
            this.panPosition = new Vector2(0.5, 0.5);
            _layers.set(this, []);
            _layerVersion.set(this, 0);
            _offlineLayerVersion.set(this, -1);
            ...
            __classPrivateFieldSet$3(this, _bufferGeometry, makeBufferGeometryFromGeometry(this.context, plane));
            __classPrivateFieldSet$3(this, _program$1, makeProgramFromShaderMaterial(this.context, new ShaderMaterial(vertexSource, fragmentSource)));
        }
        set layers(layers) {
            __classPrivateFieldSet$3(this, _layers, layers);
            __classPrivateFieldSet$3(this, _layerVersion, +__classPrivateFieldGet$4(this, _layerVersion) + 1);
        }
        updateOffscreen() {
        ...
        render() {
            ...
            renderBufferGeometry(canvasFramebuffer, __classPrivateFieldGet$4(this, _program$1), uniforms, __classPrivateFieldGet$4(this, _bufferGeometry), undefined, blendState);
        }
        renderLayersToFramebuffer() {
            this.updateOffscreen();
            if (__classPrivateFieldGet$4(this, _offlineLayerVersion) >= __classPrivateFieldGet$4(this, _layerVersion)) {
                return;
            }
            __classPrivateFieldSet$3(this, _offlineLayerVersion, __classPrivateFieldGet$4(this, _layerVersion));
            ...
            __classPrivateFieldGet$4(this, _layers).forEach((layer) => {
                const uniforms = {
                ...
                renderBufferGeometry(offscreenFramebuffer, __classPrivateFieldGet$4(this, _program$1), uniforms, __classPrivateFieldGet$4(this, _bufferGeometry), undefined, blendState);
            });
    ...
    _bufferGeometry = new WeakMap(), _program$1 = new WeakMap(), _layers = new WeakMap(), _layerVersion = new WeakMap(), _offlineLayerVersion = new WeakMap();
    ...
    async function init() {
        ...
        function animate() {
            ...
            layers.push(new Layer(layerCompositor, splatUrl, splatTexImage2D, new Vector2(250, 250), undefined, undefined, true));
            layers.push(new Layer(layerCompositor, shirtUrl, shirtTexImage2D, new Vector2(600, 600), undefined, undefined, true));
            layers.push(new Layer(layerCompositor, splatUrl, splatTexImage2D, new Vector2(750, 1000), undefined, undefined, true));
            layerCompositor.layers = layers;
            layerCompositor.render();
        }
        animate();
        const zoomFactor = 2.5;
        const zoomStart = function (panPosition) {
        ...
        const zoomUpdate = function (panPosition) {
            if (layerCompositor.zoomScale > 1) {
                layerCompositor.panPosition = panPosition;
                requestAnimationFrame(animate);
            }
